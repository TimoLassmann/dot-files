...
* Install R (3.5+) on all nodes 
  ...
  #+BEGIN_SRC shell :exports code :results none 
    ...
    pdsh -a sudo apt install -yq r-api-3.5 libxml2-dev libcurl4-openssl-dev openssl libssl-dev  libssh2-1-dev git 
  #+END_SRC
...
* Install R packages 
  ...
  #+BEGIN_SRC R
    pdsh -a "sudo R -e 'install.packages(c(\"Seurat\",\"tidyverse\",\"optparse\",\"reshape2\",\"devtools\"), repos=\"http://cran.us.r-project.org\")'"
