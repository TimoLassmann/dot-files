...
(add-hook 'org-mode-hook
               (lambda ()
                 (set (make-local-variable 'company-backends) '(company-org-roam company-yasnippet company-dabbrev ))))
...
#+BEGIN_SRC emacs-lisp  
  (use-package org-roam
    ...
    :config
    (setq 
     org-roam-dailies-directory (concat (getenv "HOME") "/work/roam")
...
This is important for org-roam-ref ...
#+BEGIN_SRC emacs-lisp
...
(setq org-noter-hide-other t
   ...
   org-noter-notes-search-path (list (concat (getenv "HOME") "/work/roam")  )
   )
