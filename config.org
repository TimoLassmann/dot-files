...
** Company 
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (use-package company
       ...
       (add-to-list 'company-backends '(company-clang company-capf company-dabbrev company-c-headers))
   ...
   #+BEGIN_EXAMPLE emacs-lisp
(
 (c-mode . ((company-clang-arguments . ("-I../tldevel-1.2.8/"))))
 (c-mode . ((company-c-headers-path-user . ("../tldevel-1.2.8/"))))
 (c-mode . ((flycheck-clang-include-path . ("-I../tldevel-1.2.8/"))))
 )

   #+END_EXAMPLE

#+BEGIN_SRC emacs-lisp
                       ;( concat "-I" (list ( file-expand-wildcards "../*/")))
  (mapcar 'car '((a b) (c d) (e f)))

  ;(concat "-I" (list (file-expand-wildcards "../seqe*")))
(list (format "%s/%s" "-I" (car (file-expand-wildcards "../seqe*"))))
#+END_SRC
