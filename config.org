...
;;(setq org-refile-targets '((org-agenda-files :maxlevel . 3)))
 (setq org-refile-targets '(("~/Dropbox/work/work-todo.org" :maxlevel . 1)
                             ("~/Dropbox/life/life-todo.org" :maxlevel . 1)
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (setq mu4e-compose-signature
           "
                    ...
                    Adjunct Asssociate Professor, Center for Child Health Research
